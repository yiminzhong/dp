    ...
    public function login(){
        ...
        if (request()->isMethod('post')){
            ...
            if ($validator->passes()) {
                ...
                $tryuser = \App\User::where('username','=',$username)->first();
...
//                }
                ...
                if (auth('admin')->attempt(array('username' => request('username', ''), 'password' => request('password', '')), request('remember', 0) ? true : false)) {
