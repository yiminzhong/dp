...
<head>
    ...
    <meta name="keywords" content="易敏忠招聘出品">
    <meta name="description" content="易敏忠招聘出品">
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">易敏忠</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">易敏忠2</a>
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">出品</span>
            <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            <nav class="nav navbar-nav">
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 发布资讯 <i class="Hui-iconfont">&#xe6d5;</i></a>
